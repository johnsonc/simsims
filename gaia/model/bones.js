...
const fullSkeletonNodes = {
    ...
    // Sternum and Costal Cartilages (for intercostal muscles, pectoralis major, rectus abdominis)
    "sternum_manubrium": { pos: [0, 14, 1.5], parent: "spine_top" }, // Top of sternum
    "sternum_body": { pos: [0, 12, 1.5], parent: "sternum_manubrium" }, // Middle of sternum
    "xiphoid_process": { pos: [0, 10, 1.5], parent: "sternum_body" }, // Bottom of sternum, for diaphragm attachment

    // Ribs (12 pairs) with Costal Cartilages
    "left_rib1": { pos: [-2, 14, -0.5], parent: "spine_top" },
    "left_costal_cartilage1": { pos: [-1, 14, 1], parent: "left_rib1" },
    "left_rib2": { pos: [-2.2, 13.5, -0.5], parent: "spine_t2" },
    "left_costal_cartilage2": { pos: [-1.2, 13.5, 1], parent: "left_rib2" },
    "left_rib3": { pos: [-2.4, 13, -0.5], parent: "spine_t3" },
    "left_costal_cartilage3": { pos: [-1.4, 13, 1], parent: "left_rib3" },
    "left_rib4": { pos: [-2.6, 12.5, -0.5], parent: "spine_t4" },
    "left_costal_cartilage4": { pos: [-1.6, 12.5, 1], parent: "left_rib4" },
    "left_rib5": { pos: [-2.8, 12, -0.5], parent: "spine_t5" },
    "left_costal_cartilage5": { pos: [-1.8, 12, 1], parent: "left_rib5" },
    "left_rib6": { pos: [-3, 11.5, -0.5], parent: "spine_t6" },
    "left_costal_cartilage6": { pos: [-2, 11.5, 1], parent: "left_rib6" },
    "left_rib7": { pos: [-3.2, 11, -0.5], parent: "spine_t7" },
    "left_costal_cartilage7": { pos: [-2.2, 11, 1], parent: "left_rib7" },
    "left_rib8": { pos: [-3.4, 10.5, -0.5], parent: "spine_t8" },
    "left_costal_cartilage8": { pos: [-2.4, 10.5, 1], parent: "left_rib8" },
    "left_rib9": { pos: [-3.2, 10, -0.5], parent: "spine_t9" },
    "left_costal_cartilage9": { pos: [-2.2, 10, 1], parent: "left_rib9" },
    "left_rib10": { pos: [-3, 9.5, -0.5], parent: "spine_t10" },
    "left_costal_cartilage10": { pos: [-2, 9.5, 1], parent: "left_rib10" },
    "left_rib11": { pos: [-2.8, 9, -0.5], parent: "spine_t11" }, // Floating rib, no cartilage
    "left_rib12": { pos: [-2.6, 8.5, -0.5], parent: "spine_t12" }, // Floating rib, no cartilage

    "right_rib1": { pos: [2, 14, -0.5], parent: "spine_top" },
    "right_costal_cartilage1": { pos: [1, 14, 1], parent: "right_rib1" },
    "right_rib2": { pos: [2.2, 13.5, -0.5], parent: "spine_t2" },
    "right_costal_cartilage2": { pos: [1.2, 13.5, 1], parent: "right_rib2" },
    "right_rib3": { pos: [2.4, 13, -0.5], parent: "spine_t3" },
    "right_costal_cartilage3": { pos: [1.4, 13, 1], parent: "right_rib3" },
    "right_rib4": { pos: [2.6, 12.5, -0.5], parent: "spine_t4" },
    "right_costal_cartilage4": { pos: [1.6, 12.5, 1], parent: "right_rib4" },
    "right_rib5": { pos: [2.8, 12, -0.5], parent: "spine_t5" },
    "right_costal_cartilage5": { pos: [1.8, 12, 1], parent: "right_rib5" },
    "right_rib6": { pos: [3, 11.5, -0.5], parent: "spine_t6" },
    "right_costal_cartilage6": { pos: [2, 11.5, 1], parent: "right_rib6" },
    "right_rib7": { pos: [3.2, 11, -0.5], parent: "spine_t7" },
    "right_costal_cartilage7": { pos: [2.2, 11, 1], parent: "right_rib7" },
    "right_rib8": { pos: [3.4, 10.5, -0.5], parent: "spine_t8" },
    "right_costal_cartilage8": { pos: [2.4, 10.5, 1], parent: "right_rib8" },
    "right_rib9": { pos: [3.2, 10, -0.5], parent: "spine_t9" },
    "right_costal_cartilage9": { pos: [2.2, 10, 1], parent: "right_rib9" },
    "right_rib10": { pos: [3, 9.5, -0.5], parent: "spine_t10" },
    "right_costal_cartilage10": { pos: [2, 9.5, 1], parent: "right_rib10" },
    "right_rib11": { pos: [2.8, 9, -0.5], parent: "spine_t11" }, // Floating rib, no cartilage
    "right_rib12": { pos: [2.6, 8.5, -0.5], parent: "spine_t12" }, // Floating rib, no cartilage

    // Pelvis
    "pelvis": { pos: [0, 4.5, 0], parent: "spine_base" },
    "pubic_symphysis": { pos: [0, 4.5, 1], parent: "pelvis" }, // For adductor muscles attachment
    ...
    "left_patella": { pos: [-2, -2, 0.5], parent: "left_knee" }, // For quadriceps tendon attachment
    ...
    "left_metatarsal_1": { pos: [-2, -8.4, 0.6], parent: "left_tarsal_2" },
    "left_metatarsal_2": { pos: [-1.9, -8.4, 0.6], parent: "left_tarsal_2" },
    "left_metatarsal_3": { pos: [-2, -8.4, 0.6], parent: "left_tarsal_2" },
    "left_metatarsal_4": { pos: [-2.1, -8.4, 0.6], parent: "left_tarsal_2" },
    "left_metatarsal_5": { pos: [-2.2, -8.4, 0.6], parent: "left_tarsal_2" },
    // Left Toe Phalanges (Big toe: 2, others: 3)
    "left_toe_big_proximal": { pos: [-2, -8.4, 0.8], parent: "left_metatarsal_1" },
    "left_toe_big_distal": { pos: [-2, -8.4, 1.0], parent: "left_toe_big_proximal" },
    "left_toe_index_proximal": { pos: [-1.9, -8.4, 0.8], parent: "left_metatarsal_2" },
    "left_toe_index_middle": { pos: [-1.9, -8.4, 0.9], parent: "left_toe_index_proximal" },
    "left_toe_index_distal": { pos: [-1.9, -8.4, 1.0], parent: "left_toe_index_middle" },
    "left_toe_middle_proximal": { pos: [-2, -8.4, 0.8], parent: "left_metatarsal_3" },
    "left_toe_middle_middle": { pos: [-2, -8.4, 0.9], parent: "left_toe_middle_proximal" },
    "left_toe_middle_distal": { pos: [-2, -8.4, 1.0], parent: "left_toe_middle_middle" },
    "left_toe_ring_proximal": { pos: [-2.1, -8.4, 0.8], parent: "left_metatarsal_4" },
    "left_toe_ring_middle": { pos: [-2.1, -8.4, 0.9], parent: "left_toe_ring_proximal" },
    "left_toe_ring_distal": { pos: [-2.1, -8.4, 1.0], parent: "left_toe_ring_middle" },
    "left_toe_little_proximal": { pos: [-2.2, -8.4, 0.8], parent: "left_metatarsal_5" },
    "left_toe_little_middle": { pos: [-2.2, -8.4, 0.9], parent: "left_toe_little_proximal" },
    "left_toe_little_distal": { pos: [-2.2, -8.4, 1.0], parent: "left_toe_little_middle" },
    ...
    "right_patella": { pos: [2, -2, 0.5], parent: "right_knee" }, // For quadriceps tendon attachment
    ...
    "right_metatarsal_1": { pos: [2, -8.4, 0.6], parent: "right_tarsal_2" },
    "right_metatarsal_2": { pos: [1.9, -8.4, 0.6], parent: "right_tarsal_2" },
    "right_metatarsal_3": { pos: [2, -8.4, 0.6], parent: "right_tarsal_2" },
    "right_metatarsal_4": { pos: [2.1, -8.4, 0.6], parent: "right_tarsal_2" },
    "right_metatarsal_5": { pos: [2.2, -8.4, 0.6], parent: "right_tarsal_2" },
    // Right Toe Phalanges (Big toe: 2, others: 3)
    "right_toe_big_proximal": { pos: [2, -8.4, 0.8], parent: "right_metatarsal_1" },
    "right_toe_big_distal": { pos: [2, -8.4, 1.0], parent: "right_toe_big_proximal" },
    "right_toe_index_proximal": { pos: [1.9, -8.4, 0.8], parent: "right_metatarsal_2" },
    "right_toe_index_middle": { pos: [1.9, -8.4, 0.9], parent: "right_toe_index_proximal" },
    "right_toe_index_distal": { pos: [1.9, -8.4, 1.0], parent: "right_toe_index_middle" },
    "right_toe_middle_proximal": { pos: [2, -8.4, 0.8], parent: "right_metatarsal_3" },
    "right_toe_middle_middle": { pos: [2, -8.4, 0.9], parent: "right_toe_middle_proximal" },
    "right_toe_middle_distal": { pos: [2, -8.4, 1.0], parent: "right_toe_middle_middle" },
    "right_toe_ring_proximal": { pos: [2.1, -8.4, 0.8], parent: "right_metatarsal_4" },
    "right_toe_ring_middle": { pos: [2.1, -8.4, 0.9], parent: "right_toe_ring_proximal" },
    "right_toe_ring_distal": { pos: [2.1, -8.4, 1.0], parent: "right_toe_ring_middle" },
    "right_toe_little_proximal": { pos: [2.2, -8.4, 0.8], parent: "right_metatarsal_5" },
    "right_toe_little_middle": { pos: [2.2, -8.4, 0.9], parent: "right_toe_little_proximal" },
    "right_toe_little_distal": { pos: [2.2, -8.4, 1.0], parent: "right_toe_little_middle" },
