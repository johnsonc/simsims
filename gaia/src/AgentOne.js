...
class AgentOne extends GameEntity {
  constructor() {
    ...
    // Initialize animations right away
    // Create dummy animation objects
    this.animations.set('IDLE', {
      reset: function() { 
        console.log("IDLE Animation reset");
        return this; // Return this for method chaining
      },
      fadeIn: function(duration) { 
        console.log(`IDLE Animation fade in: ${duration}s`);
        return this; // Return this for method chaining
      },
      fadeOut: function(duration) { 
        console.log(`IDLE Animation fade out: ${duration}s`);
        return this;
      }
    });
    ...
    this.animations.set('WALK', {
      reset: function() { 
        console.log("WALK Animation reset");
        return this; // Return this for method chaining
      },
      fadeIn: function(duration) { 
        console.log(`WALK Animation fade in: ${duration}s`);
        return this; // Return this for method chaining
      },
      fadeOut: function(duration) { 
        console.log(`WALK Animation fade out: ${duration}s`);
        return this;
      }
    });
    ...
    this.ui = {
      currentState: document.getElementById('currentState') || { 
        textContent: '' // Provide a dummy element if not found
      }
    };
    ...
    // Default to idle state (moved to after initialization)
  ...
  async initDatabase() {
    try {
      // Check if initSqlJs is defined globally
      if (typeof initSqlJs === 'undefined') {
        console.warn("SQL.js library not loaded, using mock database");
        // Create a mock database object
        /*
        this.dataManager.db = {
          exec: (sql) => console.log(`Mock DB exec: ${sql}`),
          run: (sql, params) => console.log(`Mock DB run: ${sql}`, params),
          all: (sql, params) => {
      ...
      // Create a mock database as fallback
      this.dataManager.db = {
        exec: (sql) => console.log(`Mock DB exec: ${sql}`),
        run: (sql, params) => console.log(`Mock DB run: ${sql}`, params),
        all: (sql, params) => {
  ...
  updatePhysics(delta) {
    if (this.physicsWorld && typeof this.physicsWorld.step === 'function') {
  ...
  setupPhysics() {
    ...
    this.physicsWorld = {
      // Add dummy step method
      step: (delta) => {
        // No-op or basic simulation
        //console.log(`Physics step: ${delta}s`);
      }
    };
  }
